...
export function InputNumberQuantity(props: InputNumberQuantityProps) {
  ...
  return (
    <div className="flex">
      <button className="border border-gray-200 text-2xl aspect-square min-w-[48px] hover:cursor-pointer flex justify-center items-center" onClick={handleOnClickRemoveButton}>
      ...
      <button className="border border-gray-200 text-2xl aspect-square min-w-[48px] hover:cursor-pointer flex justify-center items-center" onClick={handleOnClickAddButton}>
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
